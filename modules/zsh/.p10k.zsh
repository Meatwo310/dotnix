...
# Generated by Powerlevel10k configuration wizard on 2026-03-31 at 03:13 JST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh.
# Wizard options: powerline, ascii, lean_8colors, 2 lines, disconnected, sparse, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='$(_my_prompt_char)'
